<div class="navbar-header">
    <ul class="nav navbar-nav ">
        <li class="nav-item text-center">
            <a class="navbar-brand" style=" justify-content: center" href="{{ route('dashboard') }}"><img
                    style="height:90px" src="{{ asset($setting->logo) }}">
            </a>
        </li>
...
<div class="main-menu-content" style="margin-top:20%!important">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        @if (Auth::user()->role_id === 1)
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#">
                    <i class="fa fa-dollar"></i><span class="menu-title text-truncate"
                        data-i18n="Invoice">{{ __('messages.ADS') }}
                    </span>
                </a>
                <ul class="menu-content">
                    ...
                    <li class="{{ Route::currentRouteName() == 'view.draft' ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('view.draft') }}">
                            <i class="fa fa-save"></i><span class="menu-item text-truncate"
                                data-i18n="List">{{ __('messages.VIEW') }} {{ __('messages.DRAFT') }}</span>
                        </a>
                    </li>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#">
                    <i class="fa fa-camera"></i><span class="menu-title text-truncate"
                        data-i18n="Invoice">{{ __('messages.Media') }}
                    </span>
                </a>
                <ul class="menu-content">
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#">
                    <i class="fa fa-dollar"></i><span class="menu-title text-truncate"
                        data-i18n="Invoice">{{ __('messages.P_PAC') }}
                    </span>
                </a>
                <ul class="menu-content">
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#">
                    <i class="fa fa-pencil"></i><span class="menu-title text-truncate"
        ...
        @else
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="#">
                    <i class="fa fa-shopping-cart"></i><span class="menu-title text-truncate"
                        data-i18n="Invoice">{{ __('messages.BusinessProfile') }}
                    </span>
                </a>
                <ul class="menu-content">
            ...
            <li class="nav-item has-sub open" style="">
                <a class="d-flex align-items-center" href="#">
                    <i class="fa fa-camera"></i><span class="menu-title text-truncate" data-i18n="Invoice">Media
                    </span>
                </a>
                <ul class="menu-content">
                    <li class="">
                        <a class="d-flex align-items-center" href="http://127.0.0.1:8000/media">
                            <i class="fa fa-list"></i><span class="menu-item text-truncate"
                                data-i18n="List">View</span>
                        </a>
                    </li>
                    <li class="">
                        <a class="d-flex align-items-center" href="http://127.0.0.1:8000/media/add?0">
                            <i class="fa fa-plus"></i><span class="menu-item text-truncate"
                                data-i18n="List">Add</span>
                        </a>
                    </li>
