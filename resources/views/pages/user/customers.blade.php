    ...
    <div class="modal-dialog modal-lg  modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">Add New Customer</h5>
...
<div class="modal fade upModel modal-success" id="" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg  modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel110">Update Customer</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body ">
            ...
            <div class="card">
                <div class="card-header" >
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> <span class="badge badge-light-primary">All Customer List</span></li>
                    </ol>
               
                    <a  type="button" class="btn btn-sm btn-primary waves-effect addnew">
                        <i data-feather='plus-circle'></i>   <span>New Customer</span>
                    </a >
...
//        "columnDefs": [{ responsivePriority: 1, targets: 0 }],
        "ajax":
            {
                "url":"<?= route('list.customer') ?>","dataType":"json","type":"POST",
                "data": function ( d )
                {
...
{
  toastr.remove();  
  toastr['warning']('Are you sure you want to delete this Customer <b>'+$(this).data('ttl')+'</b>?<br /><br /><button type="button" data-did="'+$(this).data('did')+'" class="btn-sm btn-danger clear condel">Confirm</button>',
 'Warning', {
      closeButton: true,
      tapToDismiss: false,
      progressBar: true
